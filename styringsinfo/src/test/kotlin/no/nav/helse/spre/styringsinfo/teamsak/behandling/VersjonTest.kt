...
internal class VersjonTest {
    ...
    fun `Evaluerer versjon ut i fra felter`() {
        ...
        assertEquals(Versjon.of("1.0.1"), Versjon.of(initielleFelter + "saksbehandlerEnhet" + "beslutterEnhet" + "periodetype" + "mottaker" + "hendelsesmetode" + "behandlingstype" - "behandlingtype"))
    }
