...
internal class TomAnnulleringRiver(
    ...
    private fun lagPdf(organisasjonsnummer: String, fødselsnummer: String, tomAnnulleringMessage: TomAnnulleringMessage): String {
        ...
        val tomAnnulleringPdfPayload = tomAnnulleringMessage.toPdfPayload(organisasjonsnavn, navn)
